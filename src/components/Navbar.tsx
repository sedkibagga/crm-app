          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="dropdownMenu2">
                ...
                <li><a className="dropdown-item" href="#">Something else here 2</a></li>
              </ul>
            </li>
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="dropdownMenu3">
                ...
                <li><a className="dropdown-item" href="#">Another action 3</a></li>
                <li><hr className="dropdown-divider" /></li>
                <li><a className="dropdown-item" href="#">Something else here 3</a></li>
              </ul>
            </li>
